...
(function($){
	...
	$.notifications.success = function( msg, options ){
        return $.notifications( '<img src="/assets/top_ok.png" style="vertical-align: middle; "/> '+msg, $.extend( {}, options, { type : "success"}) );
    };

    $.notifications.error = function( msg, options ){
        return $.notifications( '<img src="/assets/top_error.png"  style="vertical-align: middle; "/> '+msg, $.extend( { }, options, { type : "error" }) );
    };

    $.notifications.warning = function( msg, options ){
        return $.notifications( '<img src="/assets/top_alert.png"  style="vertical-align: middle; "/> '+msg, $.extend( {}, options, { type : "warning" }) );
    };
